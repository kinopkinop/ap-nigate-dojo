    ...
    <main>
      <header className="topbar">
        ...
        <nav aria-label="メインメニュー">
          ...
          <button className={mode === "weak" ? "active" : ""} onClick={() => { setMode("weak"); setWeakIds(buildRound(category, progress, weakIds, false, false, true)); setWeakPosition(0); setRevealed(false); setQuizChoice(null); setQuizResult(null); setQuizUnsure(false); setQuizConfident(false); }}>苦手だけ <span className="navCount">{weakCount}</span></button>
